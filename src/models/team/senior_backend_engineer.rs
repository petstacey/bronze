...
#[derive(Debug)]
pub struct SeniorBackendEngineer {
    attributes: BaseAgent,
    bug_count: u8,
    bugs: Option<String>,
}

impl SeniorBackendEngineer {
    pub fn new() -> Self {
        let attributes: BaseAgent = BaseAgent {
            objective: "Reviews and improves backend code for the webserver".to_string(),
            position: "Senior Backend Developer".to_string(),
...
#[async_trait]
impl SpecialFunctions for SeniorBackendEngineer {
